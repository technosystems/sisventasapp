...
@section('breadcrumb','TIPO DE EQUIPOS')
@section('content')
 <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Tipo de equipos</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Listado de tipos de equipos
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col-lg-12">
      <div class="card card-line-primary">
            <div class="card-header">
              <h4 class="card-title">Listado de tipos de equipos</h4>
            </div>
            <div class="card-body">
                    ...
                    @foreach ($academias as $element)
                      <tr>
                        ...
                        <td>
                          ...
                          <span class="btn-inner--icon"><i class="mdi mdi-pencil"  data-bs-toggle="tooltip" data-bs-placement="top" title="Editar Clase de equipo" data-container="body" data-animation="true"></i></span>
                        </button>
                        
                      </td>
                       
                      </tr>
                       @include('admin.equipos.partials.modal.edit')
                    @endforeach
                  </tbody>
                </table>
            </div>
  ...
  @include('admin.equipos.partials.modal.create')
