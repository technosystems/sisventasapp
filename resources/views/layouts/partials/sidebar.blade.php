            ...
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons">
                   ...
                   <div class="navbar-header d-xl-block d-none ">
                    <ul class="nav navbar-nav">
                        <li class="nav-item"><a class="navbar-brand" href="{{ url('admin/dashboard') }}">
                        <img src="{{ asset('images/logo/6230aefd86ad0.png') }}" style="margin-left: 4em;" class=" " height="60">
                 </a></li>
             </ul>
        </div>
            </div>
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-user">
                   ...
                   <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                     <a class="dropdown-item" href="{{ url('admin/configuraciones') }}">
                        <i class="mr-50 fas fa-cog"></i>
                         Configuraciones
                     </a>
                    <a class="dropdown-item" href="{{ url('admin/usuario',auth()->user()->id) }}">
