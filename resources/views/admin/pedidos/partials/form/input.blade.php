...
<div class="row">
	<div class="col-sm-6">
            ...
            <input id="txtCodigo" type="text" class="form-control txtCodigo" name="codigo" placeholder="Código de producto"  value="{!! old('codigo') !!}" oninvalid="this.setCustomValidity('Debe ingresar un código para registrar el producto')" required oninput="setCustomValidity('')">
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
