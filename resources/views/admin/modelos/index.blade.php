...
@section('breadcrumb','MODELOS')
@section('content')
 <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Modelos</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Listado de modelos
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <table id="tableExport" class="display table table-striped table-hover" >
                  ...
                  <tbody>
                    @foreach ($academias as $element)
                      <tr>
                        <td>{{ $element->descripcion }} | {{ $element->descripcion_tecnica }}</td>
                        ...
                        <td>
                          ...
                          <span class="btn-inner--icon"><i class="mdi mdi-pencil"  data-bs-toggle="tooltip" data-bs-placement="top" title="Editar Modelo de equipo" data-container="body" data-animation="true"></i></span>
                        </button>
                        
                      </td>
                       
                      </tr>
                       @include('admin.modelos.partials.modal.edit')
                    @endforeach
                  </tbody>
                </table>
            </div>
  ...
  @include('admin.modelos.partials.modal.create')
