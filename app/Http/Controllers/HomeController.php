...
class HomeController extends Controller
{
    ...
    public function index()
    {
       ...
       $tasa = $this->bolivares(); 
            ...
            return view('admin.home.index', compact('revenue_mes','revenue','expense','recent_expense','purchase', 'month','products', 'yearly_sale_amount', 'recent_sale','recent_purchase','best_selling_qty', 'yearly_best_selling_qty', 'yearly_best_selling_price','mes_actual','productos','caja_1','caja_2','caja_3','caja_4','caja_5','caja_6','caja_7','caja_8','caja_9','caja_10','caja_11','caja_12','current_year','caja_mes_anterior','config','caja_mes_actual','tasa'));
